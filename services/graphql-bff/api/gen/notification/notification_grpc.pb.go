...
const (
	NotificationService_SendNotification_FullMethodName              = "/notificationpb.NotificationService/SendNotification"
	NotificationService_GetDeliveryStatus_FullMethodName             = "/notificationpb.NotificationService/GetDeliveryStatus"
	NotificationService_UpdateNotificationPreferences_FullMethodName = "/notificationpb.NotificationService/UpdateNotificationPreferences"
)
...
type NotificationServiceClient interface {
	// SendNotification creates and enqueues an outbound notification.
	SendNotification(ctx context.Context, in *SendNotificationRequest, opts ...grpc.CallOption) (*SendNotificationResponse, error)
	// GetDeliveryStatus returns the current delivery state for a notification.
	GetDeliveryStatus(ctx context.Context, in *GetDeliveryStatusRequest, opts ...grpc.CallOption) (*GetDeliveryStatusResponse, error)
	// UpdateNotificationPreferences sets per-tenant channel + event-type preferences.
